...
# ============================================================
#
# This script cleans ALL CSV files inside:
#
#   output/
#   output/satellite/
#   output/processed/
#   data/
#
# Already cleaned files (*_Clean.csv) are skipped.
#
# Original CSV files are NEVER modified.
#
# All cleaned files are saved inside:
#
#   output/processed/
#
# A cleaning report is also created:
#
#   output/processed/Data_Cleaning_Report.csv
#
# ============================================================
    ...
    for directory in search_directories:
        ...
        for root, dirs, files in os.walk(directory):
            ...
            for file in files:
                ...
                # ------------------------------------------------
                # Avoid processing report generated by this script
                # ------------------------------------------------

                if file == "Data_Cleaning_Report.csv":
                    continue
...
# ============================================================
# 7. CLEAN SPECIAL NUMERIC COLUMNS
# ============================================================
    ...
    for column in df.columns:
        ...
        if any(
            ...
            if (
                ...
                # Convert only if majority looks numeric
                if valid_ratio >= 0.60:
...
def clean_dataframe(
    ...
    df = clean_special_numeric_columns(
        df
    )
...
# ============================================================
# 18. GENERATE UNIQUE CLEAN FILE NAME
# ============================================================
...
def get_unique_output_path(
    ...
    # --------------------------------------------------------
    # Prevent overwriting if same filename exists
    # --------------------------------------------------------
...
def main():
    ...
    print(
        "Already cleaned *_Clean.csv files were skipped."
    )

    print(
        "PNG / JPG / TIF / PKL / PY files were ignored."
    )
